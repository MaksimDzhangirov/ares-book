...
<ul>
<li>название контактной площадки Name;</li>
<li>диаметр самой контактной площадки (Diameter);</li>
<li>Drill Mark (Отметка для сверления) – это диаметр отверстия контактной площадки, когда печатная плата распечатывается на принтере или графопостроителе не в режиме Drill. Он обычно меньше, чем Drill Hole, поскольку используется для выставки сверла по центру отверстия.</li>
<li>Drill Hole (Диаметр высверливаемого отверстия) – диаметр отверстия контактной площадки, который используется при выборе команды создания файла, используемого для производства печатных плат. Это также диаметр отверстий, который используется для создания изображения в режиме Drill.</li>
<li>Guard Gap (Защитный зазор) определяет расстояние, на которое увеличивается радиус контактной площадки при создании защитной паяльной маски. Если защитная маска должна покрывать контактную площадку, то выберите значение Guard Gap меньше 0 (например, –1). Это можно использовать, например, чтобы переходные отверстия не появлялись на защитной паяльной маске.</li>
<li>выпадающий список Present и Not Present определяет – используется или не защитный зазор.</li>
</ul>
<center><img src="images/chapter5/cirpadstyle.png"></center>
<center>Рис. 41</center>
<p>В случае сквозной квадратной контактной площадки задается сторона квадрата (Square). В случае прямоугольной контактной площадки со срезанными углами задается длина (Width) и ширина (Height). В случае площадки для краевых соединителей задается длина (Width), и ширина (Height), радиус скругления с одной стороны (Radius). В случае квадратной контактной площадки для поверхностного монтажа задается длина (Width), и ширина (Height), радиус скругления (Radius) всех сторон. В случае многоугольной контактной площадки для поверхностного монтажа задается многоугольник, определяющий контактную площадку.</p>
<p>В нижней части диалогового окна, в разделе Changes (Тип изменений) можно определить будет ли этот стиль контактной площадки использоваться для будущих проектов (режим Update Defaults – обновить стили по умолчанию) или только локально для текущего проекта (режим Local Edit – локальное использование).</p>
<p>После нажатия на кнопку OK новый стиль контактной площадки станет доступен в селекторе объектов.</p>
...
<ol>
<li>Используя иконки двумерной графики 2D Graphics Line Mode, 2D Graphics Arc Mode или 2D Graphics Closed Path Mode, нарисовать замкнутую область, чтобы определить форму нового стиля контактной площадки. Это можно сделать в любом слое.</li>
...
<li>Вызовите команду New Pad Style из меню Library.</li>
<li>Введите название нового стиля контактной площадки.</li>
<li>Выберите тип контактной площадки SMT -> Polygonal.</li>
<li>Нажмите кнопку OK.</li>
<li>Если необходимо, определите Guard Gap для стиля контактной площадки.</li>
<li>Если необходимо создать стиль только для текущей разводки печатной платы, то выберите Local Edit вместо Update Defaults.</li>
...
<p>New Pad Stack… – открывает диалоговое окно (Рис. 42) создания новых стеков контактных площадок.</p>
...
<p>В поле Name вводится название стека контактных площадок, а в выпадающем списке Initial Style определяется стиль контактных площадок по умолчанию. Во всех слоях первоначально будет использоваться этот стиль контактной площадки. После ввода названия и выбора стиля по умолчанию нажмите кнопку Continue.</p>
<p>В новом открывшемся диалоговом окне (Рис. 43) можно отредактировать:</p>
<ul>
<li>в разделе Name and Type название и тип стека контактных площадок – Drilled (с круглым отверстием), Slotted (c прямоугольной прорезью), SMT (для поверхностного монтажа).</li>
<li>в разделе Drill Hole параметры Drill Mark и Drill Hole. Drill Mark (Отметка для сверления) – это диаметр отверстия контактной площадки, когда печатная плата распечатывается на принтере или графопостроителе не в режиме Drill, обозначающей центр отверстия. Он обычно меньше, чем Drill Hole, поскольку используется для выставки сверла по центру отверстия. Drill Hole (Диаметр высверливаемого отверстия) – диаметр отверстия контактной площадки, который используется при выборе команды создания файла, используемого для производства печатных плат. Это также диаметр отверстий, который используется для создания изображения в режиме Drill.</li>
<li>в разделе Slot параметр Slot Width – длина прорези, Slot Height – ширина прорези, Slot Tool – диаметр фрезы для создания прорези.</li>
<li>в разделе Top Side определяется стиль контактной площадки для медного слоя (Copper), слоя паяльной маски (Resist) и пасты (Paste) верхней стороны платы. Выпадающий список для выбора слоя паяльной пасты активен только при выборе тип стека контактных площадок SMT.</li>
<li>в разделе Bottom Side определяется стиль контактной площадки для медного слоя (Copper), слоя паяльной маски (Resist) и пасты <strong>(Paste)</strong> нижней стороны платы. Выпадающий список для выбора слоя паяльной пасты всегда не активен и при выборе тип стека контактных площадок SMT выбирается только для верхнего слоя платы.</li>
<li>в разделе <strong>Inner Layers</strong> определяется стиль контактной площадки для внутренних слоев печатной платы Inner1…Inner14.</li>
</ul>
