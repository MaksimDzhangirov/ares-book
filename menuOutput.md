...
<p>Существует множество преимуществ использования ODB++, а не других форматов файлов для производства печатных плат:</p>
<ul>
<li>ODB++ – это единственный стандартный формат, широко используемый при создании печатных плат.</li>
<li>Вся информация, требуемая для производства печатной платы, включая порядок слоев, размеры инструментов и типы отверстий включена в базу данных; таким образом, не нужен информационный файл для ручной настройки инструмента.</li>
<li>Информация о типах корпусов, размещении компонентов и списке соединений также включена, поэтому автоматическую установку и проверку платы можно осуществить, используя ODB++ данные.</li>
<li>Области металлизации представляют собой векторные многоугольники, а не растровое изображение; это приводит к меньшим размерам файлов, особенно для плат больших размеров.</li>
<li>Доступен бесплатный просмотрщик ODB++ файлов, который позволяет проверить печатную плату, используя независимый программный пакет перед её отсылкой производителю.</li>
</li>
</ul>
<p>Установленный флажок в нижней левой части Run Valor ODB++ Viewer When Done? позволяет автоматически загрузить файл в универсальный просмотрщик Valor, позволяя просмотреть получившиеся файлы до отправки их производителю печатных плат. Пользователю необходимо загрузить и установить бесплатный просмотрщик Valor, чтобы эта функция была доступной.</p>
<p>Вкладка Log позволяет добавить специфические указания, касающиеся производства платы.</p>
<p>Остальные настройки аналогичны настройкам, используемым в команде Gerber/Excellon Output…</p>
<p>IDF Output… – экспортирование печатных плат в механические САПР, используя стандартный формат IDF (Рис. 21).</p>
<center><img src="/images/chapter2/idf.jpg"></center>
<center>Рис. 21</center>
<p>Все настройки аналогичны настройкам, используемым в команде ODB++ Output…</p>
<p>3D Visualization – открывает диалоговое окно, позволяющее создать и просмотреть созданное трехмерное изображение печатной платы. Смотри также раздел «3D просмотрщик».</p>
</div>